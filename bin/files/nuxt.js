 ...
 * @tests ./frameworks.test.ts
 */
const appVue = (typescript, scss, mpa) => `<script setup${typescript ? ' lang="ts"' : ''}></script>
 ...
 * @tests ./frameworks.test.ts
 */
const indexVue = (typescript, scss, tailwindcss) => `<script setup${typescript ? ' lang="ts"' : ''}></script>
 ...
 * @tests ./frameworks.test.ts
 */
const dashboardVue = (typescript, scss, tailwindcss) => `<script setup${typescript ? ' lang="ts"' : ''}>
...
`;
exports.dashboardVue = dashboardVue;
/**
...
.welcome_block {
  ${tailwindcss
    ? `@apply flex flex-col items-center gap-4;`
    : `display: flex; flex-direction: column; align-items: center; gap: 1rem;`}${scss
    ? ``
    : `
}`}
...
`;
exports.welcomeBlockVue = welcomeBlockVue;
/**
 ...
 * @tests ./frameworks.test.ts
 */
const buttonDefaultVue = (typescript, scss, tailwindcss) => `<script setup${typescript ? ' lang="ts"' : ''}>
...
`;
exports.buttonDefaultVue = buttonDefaultVue;
/**
 ...
 * @tests ./frameworks.test.ts
 */
const defaultLayoutVue = (typescript, scss, tailwindcss) => `<script setup${typescript ? ' lang="ts"' : ''}></script>
...
.layout_wrapper {
  ...
  ${tailwindcss
    ...
    : `display: flex; flex-direction: column; align-items: center; justify-content: center;`}${scss
    ? ``
    : `
}`}
...
`;
exports.defaultLayoutVue = defaultLayoutVue;
/**
 ...
 * @tests ./frameworks.test.ts
 */
const adminLayoutVue = (typescript, scss, tailwindcss) => `<script setup${typescript ? ' lang="ts"' : ''}></script>
...
`;
exports.adminLayoutVue = adminLayoutVue;
/**
 * Nuxt Logo SVG.
 * @returns string
 * @tests ./frameworks.test.ts
 */
exports.nuxtjsSVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 298">
 ...
 * @tests ./frameworks.test.ts
 */
exports.authMiddleware = `const isAuthenticated = () => true
 ...
 * @tests ./frameworks.test.ts
 */
const countUtils = (typescript) => `${typescript
    ? `import { CountType } from '~/types'
 ...
 * @tests ./frameworks.test.ts
 */
const utilsTest = (mpa) => `import { describe, expect, it } from 'vitest'
 ...
 * @tests ./frameworks.test.ts
 */
exports.typesIndex = `export type CountType = number
`;
/**
 * styles/global.scss
